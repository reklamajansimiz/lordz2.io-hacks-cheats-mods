// ==UserScript==
// @name         Lordz2.io COIN HACK - Lordz2io Hacks - Best Lordz2 Cheat 2019 to 2020
// @description  Lordz2io Mods Features: Coin Hack, Faster Movement, Auto Heal, More Units, FPS, Adblock
...
// @updateURL    https://io-mods.com/mods/lordz2io.user.js
// @downloadURL  https://io-mods.com/mods/lordz2io.user.js
// @grant          GM_setValue
// @grant          GM_getValue
// @match        *://lordz2.io/*
// @match        *iogames.space/*
...
$('#replacement').remove();
$('#lordz2-io_728x90').prepend('<div class="list1"></div>');
...
$('.webgl-content').css('background-color',''+changecolor+'');
}
...
function colorfulmod() {
    ...
    colorsrain = ["transparent"];
      ...
      setInterval(function() {
                ...
                $(".webgl-content").css("background-color",selectedcolor);
      }, 3000);
}
